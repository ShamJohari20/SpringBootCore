...
@Repository("emysqldao")

public class EmployeeMysqlDAOImpl implements IEmpolyeeDAO {

//	@Autowired
	private DataSource ds;
	private static final String INSERT_EMP = "INSERT INTO EMPLOYEE(ENAME,DESG,SALARY) VALUES (?,?,?)";
